...
import { EditableDistributionCommand, EditableHomeCta, EditableHomeHero } from '@/editable/sections/HomeSections'
...
export default async function HomePage() {
  ...
  return (
    <EditableSiteShell>
      ...
      <EditableDistributionCommand primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
      <EditableHomeCta />
      </main>
    </EditableSiteShell>
  )
