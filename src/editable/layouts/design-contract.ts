...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#282a31',
  '--slot4-panel-bg': '#eef1f4',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5f6877',
  '--slot4-soft-muted-text': '#7a8391',
  '--slot4-accent': '#3164e0',
  '--slot4-accent-fill': '#3164e0',
  '--slot4-accent-soft': '#d7f5e9',
  '--slot4-dark-bg': '#272a31',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eef1f4',
  '--slot4-cream': '#f4fbf7',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#d7e7ff',
  '--slot4-gray': '#eef1f4',
  '--slot4-green': '#d5f6e9',
  '--slot4-orange': '#f04f2f',
  '--slot4-yellow': '#f7d547',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #ffffff 48%, #f6f8fb 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-5xl font-black leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:text-[4.9rem]',
  ...
  button: {
    ...
    secondary: `inline-flex items-center justify-center gap-2 rounded-full border-2 border-[var(--slot4-dark-bg)] bg-transparent px-7 py-3.5 text-sm font-black text-[var(--slot4-dark-bg)] transition hover:bg-[var(--slot4-dark-bg)] hover:text-white`,
    accent: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-accent-fill)] px-7 py-3.5 text-sm font-black text-white transition hover:bg-[var(--slot4-dark-bg)]`,
  },
  media: {
...
export const aiLayoutRules = [
  ...
  'Use a white product-style masthead, blue announcement bar, mint hero panels, rounded cards, and spacious magazine sections.',
